...
```bash
python3 -m pyfiglet "EGGON" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=EGGON&font=Slant" | boxes -d stone
```
...
- Objects: `car`, `ship`, `airplane`, `rocket`, `guitar`, `computer`, `coffee`, `beer`, `cake`, `house`, `castle`, `hatch`, `crown`, `key`
...
### Source B: GitHub Octocat API (fun easter elephant)
